...
class _AnasayfaState extends State<Anasayfa> {
  ...
  Widget build(BuildContext context) {
    ...
    final double ekranYuksekligi = ekranBilgisi.size.height; //yukseklik
    final double ekranGenisligi = ekranBilgisi.size.width; //genislik
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            padding: EdgeInsets.only(top: ekranYuksekligi/77),
